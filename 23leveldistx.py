...
gamma_re = 0.0001  #decay from r to e
...
num_step = 100
step_x = 100
Delta1vec = np.linspace(-20.,20., num_step)
...
#plt.figure()
#plt.plot(Delta1vec, paveraged_e, '-')


plt.figure()
dist = np.linspace(0.0,15,1000)
W = nndist(dist, 1/1000)

#y = nndistV(V, potential, rho)
plt.plot(dist, W)
